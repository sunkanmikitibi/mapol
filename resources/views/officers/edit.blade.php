...
<div class="card">
    ...
    <div class="card-body">
            {!! Form::model($officer, ['method'=>'PUT', 'route'=>['officers.update', $officer->id]]) !!}
            <div class="row">
                    <div class="col-4">
                       ...
                       <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                               ...
                               <div class="col-6">
                              <div class="form-group">
                                  {!! Form::text('date_enlisted', null, ['class'=>' form-control form-control-sm', 'id'=>'datepicker2']) !!}
                          ...
                          <div class="row">
                               <div class="col-6">
                              <div class="form-group">
                                  {!! Form::text('date_promoted', null, ['class'=>'form-control form-control-sm', 'id'=>'datepicker3']) !!}
                              ...
                              <div class="col-6">
                              <div class="form-group">
                                  {!! Form::text('rankonenlistment', null, ['class'=>'form-control form-control-sm']) !!}
                          ...
                          <div class="row">
                               <div class="col-6">
                              <div class="form-group">
                                    {!! Form::text('div_formation', null, ['class'=>'form-control form-control-sm']) !!}
                              </div>
                              </div>
                              <div class="col-6">
                              <div class="form-group">
